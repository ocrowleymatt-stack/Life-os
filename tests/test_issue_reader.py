...
import json
import pytest
from daedalus.planner import parse_issue, IssueParser
from daedalus.planner.issue_reader import RiskLevel
...
def test_issue_parser_to_dict():
    ...
    from daedalus.planner.issue_reader import ParsedIssue
